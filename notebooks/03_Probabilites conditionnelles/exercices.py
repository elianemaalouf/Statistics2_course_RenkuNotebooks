...
class Ex_frac:
    def __init__(self, sol_index, ex_index):
        ...
        self.solutions = s.sol_dec
        self.ex_answer = widgets.Text(value= '',
                                      placeholder= 'Tapez ici',
                                      description='Réponse',
                                      disabled=False)
        
        self.instruction = widgets.HTML('Entrez votre réponse à la question {} sous forme décimale'.format(str(self.ex_index + 1)))
        ...
        def test(change): 
            ...
            self.correct_value = s.sol_dec[self.sol_index][self.ex_index]
